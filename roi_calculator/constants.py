...
COMMON_ERRORS = [
    ...
    {
        "code": "E009",
        "check": "revenue_growth_too_high",
        "severity": "warning",
        "message": "Рост выручки более 100% от baseline. Убедитесь, что прогноз обоснован пилотными данными, а не экспертной оценкой.",
    },
    {
        "code": "E010",
        "check": "opex_increase",
        "severity": "error",
        "message": "Ожидаемые затраты (TO BE) выше текущих (AS IS). Это увеличение расходов, а не снижение.",
    },
    {
        "code": "E011",
        "check": "prevention_too_high",
        "severity": "warning",
        "message": "Предотвращение рисков > 80% — крайне амбициозная оценка. Отраслевой бенчмарк: 30–50%. Проверьте пилотные данные.",
    },
    {
        "code": "E012",
        "check": "recovery_delta_too_high",
        "severity": "warning",
        "message": "Прирост ставки взыскания > 15 п.п. — нетипично. Проверьте, есть ли подтверждение пилотом.",
    },
    {
        "code": "E013",
        "check": "negative_gross",
        "severity": "error",
        "message": "Суммарный gross-эффект отрицательный. ИИ-решение ухудшает финансовые показатели. Перепроверьте параметры.",
    },
    {
        "code": "E014",
        "check": "opex_fte_double_count",
        "severity": "warning",
        "message": "Одновременно указаны снижение OPEX и оптимизация ФОТ. ФОТ — часть OPEX. Убедитесь, что экономия на персонале не учтена дважды (в OPEX-снижении и в ФОТ-сокращении).",
    },
    {
        "code": "E015",
        "check": "attribution_applied",
        "severity": "info",
        "message": "Применена доля эффекта ИИ (attribution). Эффект учтён не на 100%, а на указанную долю — в соответствии с принципом связи с инициативой.",
    },
]
